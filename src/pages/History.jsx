      ...
      <main className="flex-1 pb-8">
        ...
        {!loading && !user?.isPro && (
          <div className="flex flex-col items-center justify-center py-24 gap-4 px-4 text-center">
            ...
            <Link
              to="/pricing"
              className="mt-4 px-8 py-4 bg-emerald-600 text-white font-extrabold rounded-2xl shadow-lg hover:bg-emerald-700 hover:-translate-y-0.5 transition-all active:scale-95"
            >
              View Pricing To Upgrade
            </Link>
          </div>
        )}
        ...
        {!loading && user?.isPro && notes.length > 0 && (
